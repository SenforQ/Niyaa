...
fileprivate let mainDenseValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "UITableViewCellContentView" :*/
fileprivate let notiSortMessage:String = "vest do marker equipmentUITa"
fileprivate let userReplacementStr:String = "ewCellreader change resign retain discuss"
fileprivate let userUndertakeUrl:String = "tViewcircle place flex"
...
class AmongBind: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: mainDenseValue.reversed(), encoding: .utf8)!)
    }
    ...
    //: func showView() {
    func banMagnitudeeraction() {
        //: self.currentViewController()?.view.endEditing(true)
        self.moreHide()?.view.endEditing(true)
    ...
    func petDrawer(view: UIView) {
        ...
        view.bringSubviewToFront(self)
        //: showView()
        banMagnitudeeraction()
    }
}

//: extension TalkingPopView: UIGestureRecognizerDelegate {
extension AmongBind: UIGestureRecognizerDelegate {
    ...
    func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        if classStr == (String(notiSortMessage.suffix(4)) + "bleVi" + String(userReplacementStr.prefix(6)) + "Conten" + String(userUndertakeUrl.prefix(5))) {
            //: return false
            return false
            //: }else {
        } else {
