...
@objcMembers class MarkerOf: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: WithMediumScene?
    //: var gift: TalkingMsgGiftModel?
    var gift: ToolOf?
    //: var user: TalkingMsgUserModel?
    var user: PlayPosition?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: FeatureDistribution?
...
class WithMediumScene: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class PlayPosition: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class FeatureDistribution: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class ToolOf: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
