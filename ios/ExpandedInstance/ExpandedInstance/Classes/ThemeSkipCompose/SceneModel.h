...
@property (nonatomic, strong)WithoutModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)EndModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)AgainstModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)CancelAllModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)NeedModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)VisitModel *quoteMsgInfo;

//: @property (nonatomic, strong)BetweenInput *userInfoModel;
@property (nonatomic, strong)BetweenInput *userInfoModel;
...
@protocol TargetBlackModel
//: @end
@end
//: @interface QuestionQuickReplayModel: JSONModel
@interface TargetBlackModel: JSONModel
...
@interface WithoutModel : JSONModel
...
@property (nonatomic, strong) PlateUniformModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) AttributeModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) ComposeModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) VariableModel *wantGift; /// 想要礼物
...
@property (nonatomic, strong) NSArray<TargetBlackModel> *replay; /// v1.9.8 男性用户需要回复的选择内容
...
@interface PlateUniformModel : JSONModel
...
@interface ComposeModel: JSONModel
...
@interface AgainstModel : JSONModel
...
@interface CancelAllModel : JSONModel
...
@interface VisitModel : JSONModel
...
@property (nonatomic, strong) TimingModel *renderData;
...
@interface TimingModel : JSONModel
