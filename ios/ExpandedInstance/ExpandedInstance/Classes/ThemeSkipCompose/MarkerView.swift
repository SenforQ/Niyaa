...
fileprivate let constStateChartMsg:[UInt8] = [0x98,0x9f,0x98,0x85,0xd9,0x92,0x9e,0x95,0x94,0x83,0xcb,0xd8,0xd1,0x99,0x90,0x82,0xd1,0x9f,0x9e,0x85,0xd1,0x93,0x94,0x94,0x9f,0xd1,0x98,0x9c,0x81,0x9d,0x94,0x9c,0x94,0x9f,0x85,0x94,0x95]
...
typealias SlidingHandler = (_ direction: EnvironmentMark) -> Void
...
class MarkerView: UIView {
    ...
    var cropStart: CGFloat {
        ...
        let offset = overlay.startOffset - (user_whiteId - self.contentView.contentOffset.x)
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: constStateChartMsg.map{$0^241}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIScrollView = {
        ...
        while time <= self.duration {
            ...
            let image = self.oddArray(point: time)
            //: imv.image = image
            imv.image = image
    ...
    lazy var overlay: RedThan = {
        ...
        let overlay = RedThan(frame: self.bounds, maxCropLen: maxWidth, minCropLen: minWidth)
...
extension MarkerView {
    ...
    private func oddArray(point: CGFloat) -> UIImage {
...
extension MarkerView: UIScrollViewDelegate {
    //: func scrollViewDidScroll(_ scrollView: UIScrollView) {
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        //: var offset = scrollView.contentOffset
        var offset = scrollView.contentOffset
        //: let minx = LeftMargin - overlay.startOffset
        let minx = user_whiteId - overlay.startOffset
    ...
    func scrollViewWillBeginDragging(_ scrollView: UIScrollView) {
        ...
        self.overlay.efficiencySchedule(isShow: false)
    }
    ...
    func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
        ...
        self.overlay.efficiencySchedule(isShow: true)
    }
...
extension MarkerView {
    ...
    private func priorityThe() {
        ...
        self.contentView.snp.makeConstraints { make in
            ...
            make.leading.equalToSuperview().offset(user_whiteId)
