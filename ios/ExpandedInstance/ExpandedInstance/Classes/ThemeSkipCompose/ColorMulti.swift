...
fileprivate let app_licensePlatValue:[UInt8] = [0xb6,0xb1,0xb6,0xab,0xf7,0xbc,0xb0,0xbb,0xba,0xad,0xe5,0xf6,0xff,0xb7,0xbe,0xac,0xff,0xb1,0xb0,0xab,0xff,0xbd,0xba,0xba,0xb1,0xff,0xb6,0xb2,0xaf,0xb3,0xba,0xb2,0xba,0xb1,0xab,0xba,0xbb]

private func discountDimensionCap(detail num: UInt8) -> UInt8 {
    return num ^ 223
}

/*: "icon_home_boy" :*/
fileprivate let appGemMidData:String = "object orangeicon_ho"
fileprivate let appTransferId:String = "me_boyuntil tier"

/*: "icon_home_girl" :*/
fileprivate let showAlongsideRocketFormat:[Character] = ["i","c","o","n","_","h","o","m","e","_","g","i"]
fileprivate let userCharacteristicTitle:[Character] = ["r","l"]
...
class ColorMulti: UITableViewCell {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: app_licensePlatValue.map{discountDimensionCap(detail: $0)}, encoding: .utf8)!)
    }
...
extension ColorMulti {
    //: func setOnlineListCell(model: TalkingChatRoomMemberModel, type: TitleType) {
    func noProvision(model: AngleAdd, type: BeforeSectionBlack) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.transferAndJoinSmall(name: (String(appGemMidData.suffix(7)) + String(appTransferId.prefix(6)))), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.transferAndJoinSmall(name: (String(showAlongsideRocketFormat) + String(userCharacteristicTitle))), for: .normal)
        //: break
        //: default:
        default:
            //: break
