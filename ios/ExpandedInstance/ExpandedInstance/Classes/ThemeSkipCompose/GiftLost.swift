...
fileprivate let k_barPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class GiftLost: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: k_barPath.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var contentLabel = UILabel().then {
        ...
        $0.font = .alongsideOk(type: .Regular, fontSize: 16)
    }
}
...
extension GiftLost {
    ...
    func easy(content: String) {
        ...
        if content.isEmptyString {
            ...
            let attributes = [.foregroundColor: UIColor.white, .font: UIFont.alongsideOk(type: .Regular, fontSize: 16)] as [NSAttributedString.Key: Any]
