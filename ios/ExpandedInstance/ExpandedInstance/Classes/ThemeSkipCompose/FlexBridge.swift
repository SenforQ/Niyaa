...
@objc public enum StyleActive: UInt {
 ...
 */
//: @objcMembers public class FlexBridge: TCommonCellData {
@objcMembers public class FlexBridge: CleanShared {
    ...
    public var direction: StyleActive = .MsgDirectionIncoming
    ...
    public var translateStatus: SinkTap = .MsgTranslate_init
    ...
    public var msgModel: SceneModel = SceneModel()
    ...
    public init(direction: StyleActive) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.embraceByBold()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = OfRed(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = OfRed(isIncomming: false)
    ...
    public override func atArea(_ width: CGFloat) -> CGFloat {
