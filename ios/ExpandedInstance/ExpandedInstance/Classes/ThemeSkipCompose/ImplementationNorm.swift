...
fileprivate let notiAgainstJackValue:String = "ta discoverbtn_"
fileprivate let k_weekDespiteMessage:[Character] = ["o","n","t","i","n","u","e"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let noti_flexPath:[UInt8] = [0x83,0x84,0x83,0x9e,0xc2,0x89,0x85,0x8e,0x8f,0x98,0xd0,0xc3,0xca,0x82,0x8b,0x99,0xca,0x84,0x85,0x9e,0xca,0x88,0x8f,0x8f,0x84,0xca,0x83,0x87,0x9a,0x86,0x8f,0x87,0x8f,0x84,0x9e,0x8f,0x8e]

private func constraintShade(mode num: UInt8) -> UInt8 {
    return num ^ 234
}
...
class ImplementationNorm: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(dailyToMale), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(tweenOperate), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: SignatureAssociate)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(notiAgainstJackValue.suffix(4)) + "me_back_c" + String(k_weekDespiteMessage))
        }
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: noti_flexPath.map{constraintShade(mode: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func socialOf(title: String, isTouch: Bool) {
