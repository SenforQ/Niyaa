...
@objcMembers open class CoordinatorExtra: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = CoordinatorExtra()
    //: private(set) var currLanguage: String = MacroDefine.getSystemLangCode()
    private(set) var currLanguage: String = VersusQuit.darkFactor()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func creationBottom(_ language: String) {
...
extension String {
    ...
    public func underConnection(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = PrepareSpecify.default.languagePath
