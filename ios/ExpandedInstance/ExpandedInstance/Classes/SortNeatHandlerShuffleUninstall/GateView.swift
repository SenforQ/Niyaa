...
fileprivate let data_foundKey:[UInt8] = [0xb9,0xbe,0xb9,0xc4,0x78,0xb3,0xbf,0xb4,0xb5,0xc2,0x8a,0x79,0x70,0xb8,0xb1,0xc3,0x70,0xbe,0xbf,0xc4,0x70,0xb2,0xb5,0xb5,0xbe,0x70,0xb9,0xbd,0xc0,0xbc,0xb5,0xbd,0xb5,0xbe,0xc4,0xb5,0xb4]

fileprivate func alongDue(data num: UInt8) -> UInt8 {
...
/*: "Gifts received" :*/
fileprivate let showBelowString:String = "click command balance player bodyGifts re"
fileprivate let show_translateActorMsg:String = "ceieditored"
...
class GateView: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: data_foundKey.map{alongDue(data: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lb.text = (String(showBelowString.suffix(8)) + show_translateActorMsg.replacingOccurrences(of: "editor", with: "v")).localized
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collect.register(SignStack.self, forCellWithReuseIdentifier: SignStack.className())
        //: return collect
        return collect
        //: }()
    }()
...
extension GateView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: SignStack.className(), for: indexPath) as! SignStack
        //: let model: TalkingUserReceivedGiftModel = self.giftsDataArray[indexPath.row]
        let model: IncludeClip = self.giftsDataArray[indexPath.row]
        //: cell.configGiftItemCellWithData(giftModel: model, isNewProfile)
        cell.highlightCalculate(giftModel: model, isNewProfile)
        //: return cell
        return cell
    }
