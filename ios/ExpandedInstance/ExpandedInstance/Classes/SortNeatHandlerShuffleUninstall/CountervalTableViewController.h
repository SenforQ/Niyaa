 ...
 *
 *  MasterAmongThreshold 协议和 CountervalTableViewController 类。
 *  CountervalTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 CountervalTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class CountervalTableViewController;
//: @class CeilingThan;
@class CeilingThan;
//: @class FlexBridge;
@class FlexBridge;
...
@protocol MasterAmongThreshold <NSObject>
...
- (void)moved:(CountervalTableViewController *)controller;
...
- (void)feedbackRow:(CountervalTableViewController *)controller;
...
- (BOOL)when:(CountervalTableViewController *)controller drawing:(UIView *)view;
 ...
 */
//: - (FlexBridge *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (FlexBridge *)takeStorage:(CountervalTableViewController *)controller line:(V2TIMMessage *)data;
 ...
 */
//: - (CeilingThan *)messageController:(TUIMessageController *)controller onShowMessageData:(FlexBridge *)data;
- (CeilingThan *)accelerate:(CountervalTableViewController *)controller rebuild:(FlexBridge *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(CeilingThan *)cell;
- (void)ownerReflect:(CountervalTableViewController *)controller spot:(CeilingThan *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(CeilingThan *)cell;
- (void)easeSpeed:(CountervalTableViewController *)controller root:(CeilingThan *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(FlexBridge *)data;
- (void)modifyElement:(CountervalTableViewController *)controller stage:(NSInteger)menuType progress:(FlexBridge *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(CeilingThan *)cell;
- (void)selectUsed:(CountervalTableViewController *)controller time:(CeilingThan *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(FlexBridge *)cellData;
- (void)loop:(CountervalTableViewController *)controller saveView:(FlexBridge *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(FlexBridge *)cellData;
- (void)capacity:(CountervalTableViewController *)controller asConnect:(FlexBridge *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         CountervalTableViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】CountervalTableViewController
...
@interface CountervalTableViewController : UITableViewController

/**
 *  执行 MasterAmongThreshold 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<MasterAmongThreshold> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<FlexBridge *> *)uiMsgs;
