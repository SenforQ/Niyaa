...
fileprivate let userPackageSubmitStr:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_lounge" :*/
fileprivate let constGameTitle:String = "icon_lembrace split"

/*: "#777777" :*/
fileprivate let userHiddenFormat:[Character] = ["#","7","7","7","7","7","7"]

/*: "UID: :*/
fileprivate let noti_contextString:[Character] = ["U","I","D",":"]
...
class PutCollection: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: userPackageSubmitStr.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.transferAndJoinSmall(name: (String(constGameTitle.prefix(6)) + "ounge"))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.font = UIFont.alongsideOk(type: .Regular, fontSize: 15)
        //: lab.textColor = UIColor(hex: "#777777")
        lab.textColor = UIColor(hex: (String(userHiddenFormat)))
        //: return lab
        return lab
        //: }()
    }()
