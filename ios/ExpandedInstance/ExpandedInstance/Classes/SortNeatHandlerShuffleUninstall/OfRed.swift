...
@objcMembers public class OfRed: NSObject {
    ...
    class func official() -> OfRed {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = OfRed.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func sinkQuantityo() -> OfRed {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = OfRed.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func behindProperty() -> OfRed {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = OfRed.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func painterRemain() -> OfRed {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = OfRed.init(isIncomming: false)
        //: return layout
        return layout
