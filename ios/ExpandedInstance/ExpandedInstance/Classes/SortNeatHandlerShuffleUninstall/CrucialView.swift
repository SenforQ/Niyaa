...
fileprivate let showRegularTickGrayData:[UInt8] = [0xc3,0xc4,0xc3,0xde,0x82,0xc9,0xc5,0xce,0xcf,0xd8,0x90,0x83,0x8a,0xc2,0xcb,0xd9,0x8a,0xc4,0xc5,0xde,0x8a,0xc8,0xcf,0xcf,0xc4,0x8a,0xc3,0xc7,0xda,0xc6,0xcf,0xc7,0xcf,0xc4,0xde,0xcf,0xce]

private func attachPicture(professional num: UInt8) -> UInt8 {
    return num ^ 170
}

/*: "btn_me_edit" :*/
fileprivate let user_languageString:String = "when shebtn_"
...
class CrucialView: UITableViewCell {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: showRegularTickGrayData.map{attachPicture(professional: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.transferAndJoinSmall(name: (String(user_languageString.suffix(4)) + "me_edit")))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.textColor = UIColor.multiSince()
...
extension CrucialView {
    ...
    func theASimultaneously(titile: String, row: Int, isLast: Bool) {
    ...
    func funPrice() {
        ...
        titleBLB.font = UIFont.alongsideOk(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.alongsideOk(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
