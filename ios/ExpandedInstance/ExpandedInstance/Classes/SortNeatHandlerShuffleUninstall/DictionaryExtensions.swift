...
extension Dictionary {
    ...
    public static func picture(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func dividePending(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.picture(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
