...
class OfFlush: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        resistanceInstall(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        resistanceInstall(placeholder: nil, placeholderColor: nil)
    }
}
...
extension OfFlush {
    ...
    private func resistanceInstall(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(StreamPage().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(StreamPage().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-StreamPage().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: FactorStructure().top, left: FactorStructure().left, bottom: FactorStructure().bottom, right: FactorStructure().right)
...
extension OfFlush: UITextViewDelegate {
