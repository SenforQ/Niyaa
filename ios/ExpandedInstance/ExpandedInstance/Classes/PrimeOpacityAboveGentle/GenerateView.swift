...
open class GenerateView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = GenerateView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func tillFee() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(multipleSlide),
    ...
    @objc private func multipleSlide() {
