...
fileprivate let kCommunicateMessage:[UInt8] = [0xbd,0xc2,0xbd,0xc8,0x7c,0xb7,0xc3,0xb8,0xb9,0xc6,0x8e,0x7d,0x74,0xbc,0xb5,0xc7,0x74,0xc2,0xc3,0xc8,0x74,0xb6,0xb9,0xb9,0xc2,0x74,0xbd,0xc1,0xc4,0xc0,0xb9,0xc1,0xb9,0xc2,0xc8,0xb9,0xb8]

fileprivate func commandInvisible(uniform num: UInt8) -> UInt8 {
...
class SMountElement: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: kCommunicateMessage.map{commandInvisible(uniform: $0)}, encoding: .utf8)!)
    }
