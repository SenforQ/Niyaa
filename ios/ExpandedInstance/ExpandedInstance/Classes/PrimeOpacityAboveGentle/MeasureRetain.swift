...
/*: "App" :*/
fileprivate let const_besideFormat:String = "Apphoney true hi isolate private"

/*: "blockList_ :*/
fileprivate let notiGreatStorageEmergencyKey:[Character] = ["b","l","o","c","k","L","i","s"]
fileprivate let app_whenMessage:String = "t_out date injury speaker"
...
class MeasureRetain: NSObject {
    ...
    func somePromise(userId: String) -> Bool {
    ...
    private func outsideRebuild() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(const_besideFormat.prefix(3))))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(notiGreatStorageEmergencyKey) + String(app_whenMessage.prefix(2))) + "\(uid)")
        //: return filePath
        return filePath
    }
}
