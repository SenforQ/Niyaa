...
fileprivate let const_tipFormat:[UInt8] = [0xb5,0xb2,0xb5,0xa8,0xf4,0xbf,0xb3,0xb8,0xb9,0xae,0xe6,0xf5,0xfc,0xb4,0xbd,0xaf,0xfc,0xb2,0xb3,0xa8,0xfc,0xbe,0xb9,0xb9,0xb2,0xfc,0xb5,0xb1,0xac,0xb0,0xb9,0xb1,0xb9,0xb2,0xa8,0xb9,0xb8]

/*: "JXBannerCellID" :*/
fileprivate let user_storageBeyondId:String = "under nature oneJXBann"
fileprivate let main_springImageStr:String = "extension random constraintllID"

/*: "#FFFFFF" :*/
fileprivate let app_womanUrl:String = "map find notice application#FFFFFF"

/*: "#BDB8B5" :*/
fileprivate let appErrorValue:String = "#BDB8B5speaker last capacity put appropriate"
...
protocol AppearanceSensor: NSObjectProtocol {
    // 广告cell点击
...
class LayerView: UICollectionReusableView {
    ...
    weak var delegate: AppearanceSensor?

    //: var adBannderListData: [SocialAdBannerModel]?
    var adBannderListData: [DismissActivity]? // 广告banner数据

    //: required init?(coder: NSCoder) {
    required init?(coder: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: const_tipFormat.map{$0^220}, encoding: .utf8)!)
    }
...
extension LayerView {
    ...
    func examine(data: [DismissActivity]) {
...
extension LayerView: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(user_storageBeyondId.suffix(6)) + "erCe" + String(main_springImageStr.suffix(4))))
    }
                  ...
                  builder: JXBannerPageControlBuilder) -> JXBannerPageControlBuilder
    {
        ...
        pageControl.activeColor = UIColor(hex: (String(app_womanUrl.suffix(7))))!
        //: pageControl.inactiveSize = CGSize(width: 6, height: 6)
        pageControl.inactiveSize = CGSize(width: 6, height: 6)
        //: pageControl.inactiveColor = UIColor(hex: "#BDB8B5")!
        pageControl.inactiveColor = UIColor(hex: (String(appErrorValue.prefix(7))))!
...
extension LayerView {
    ...
    private func discloseTrain() {
        ...
        bannerView.snp.makeConstraints { make in
            ...
            make.size.equalTo(CGSize(width: dataTabUrl - 30, height: 84))
        }
    }
}
