...
enum FunctionalRevealEvolution: String {
    //: case FacebookLogin
...
@objc enum TotalervalObserve: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum PlainBottomSubtle: Int {
    //: case Unavailable = 0
...
enum ReloadScopeViaFactorClose: CaseIterable {
