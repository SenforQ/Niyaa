...
/*: "Increase：" :*/
fileprivate let constSumensityMessage:[Character] = ["I","n","c","r","e","a","s","e","："]

/*: "Decrease：" :*/
fileprivate let dataToolPointStr:String = "mark other impactDecrease："

/*: "init(coder:) has not been implemented" :*/
fileprivate let kHardStr:[UInt8] = [0x4a,0x4d,0x4a,0x57,0xb,0x40,0x4c,0x47,0x46,0x51,0x19,0xa,0x3,0x4b,0x42,0x50,0x3,0x4d,0x4c,0x57,0x3,0x41,0x46,0x46,0x4d,0x3,0x4a,0x4e,0x53,0x4f,0x46,0x4e,0x46,0x4d,0x57,0x46,0x47]

private func pastAnalyze(under num: UInt8) -> UInt8 {
    return num ^ 35
}

/*: "bg_talk_closed_tc" :*/
fileprivate let constLoopStretchProtectionMessage:[Character] = ["b","g","_","t","a","l","k","_","c","l","o","s","e","d","_","t","c"]

/*: "bg_talk_closed_tc_intimate" :*/
fileprivate let const_valueUrl:String = "every date protection delivery tweenbg_talk_"
fileprivate let app_sizePath:String = "isolate raw sampleclosed_t"
fileprivate let k_documentSubmitCharacteristicString:String = "c_intspring con near zone"

/*: "btn_intimate_close" :*/
fileprivate let userReduceFormat:[Character] = ["b","t","n","_","i","n","t","i","m","a","t","e","_","c","l","o","s","e"]

/*: "Giving gifts 、making calls and sending paid messages can increase intimacy~" :*/
fileprivate let showHereData:[UInt8] = [0x7e,0x79,0x63,0x61,0x6d,0x69,0x74,0x6e,0x69,0x20,0x65,0x73,0x61,0x65,0x72,0x63,0x6e,0x69,0x20,0x6e,0x61,0x63,0x20,0x73,0x65,0x67,0x61,0x73,0x73,0x65,0x6d,0x20,0x64,0x69,0x61,0x70,0x20,0x67,0x6e,0x69,0x64,0x6e,0x65,0x73,0x20,0x64,0x6e,0x61,0x20,0x73,0x6c,0x6c,0x61,0x63,0x20,0x67,0x6e,0x69,0x6b,0x61,0x6d,0x81,0x80,0xe3,0x20,0x73,0x74,0x66,0x69,0x67,0x20,0x67,0x6e,0x69,0x76,0x69,0x47]

/*: "1 coin = 1 intimacy" :*/
fileprivate let kBindTitle:String = "illegal daily last bubble1 coin"
fileprivate let appSecureStr:String = "ntbotm"
fileprivate let const_scholarMessage:String = "ACY"

/*: "If coins are not consumed within a certain period of time, the intimacy level will be reduced." :*/
fileprivate let noti_beyondPath:[UInt8] = [0x2e,0x64,0x65,0x63,0x75,0x64,0x65,0x72,0x20,0x65,0x62,0x20,0x6c,0x6c,0x69,0x77,0x20,0x6c,0x65,0x76,0x65,0x6c,0x20,0x79,0x63,0x61,0x6d,0x69,0x74,0x6e,0x69,0x20,0x65,0x68,0x74,0x20,0x2c,0x65,0x6d,0x69,0x74,0x20,0x66,0x6f,0x20,0x64,0x6f,0x69,0x72,0x65,0x70,0x20,0x6e,0x69,0x61,0x74,0x72,0x65,0x63,0x20,0x61,0x20,0x6e,0x69,0x68,0x74,0x69,0x77,0x20,0x64,0x65,0x6d,0x75,0x73,0x6e,0x6f,0x63,0x20,0x74,0x6f,0x6e,0x20,0x65,0x72,0x61,0x20,0x73,0x6e,0x69,0x6f,0x63,0x20,0x66,0x49]
...
class PlatformSendView: UIView {
    //: var popView: TalkingPopView?
    var popView: AmongBind?
    //: var pushType = ""
    var pushType = ""
    //: var headerData = ["Increase：".localized,"Decrease：".localized]
    var headerData = [(String(constSumensityMessage)).localized, (String(dataToolPointStr.suffix(9))).localized]
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: kHardStr.map{pastAnalyze(under: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIImageView = {
        ...
        imag.image = UIImage.transferAndJoinSmall(name: (String(constLoopStretchProtectionMessage)))
    ...
    private lazy var topView: UIImageView = {
        ...
        imag.image = UIImage.transferAndJoinSmall(name: (String(const_valueUrl.suffix(8)) + String(app_sizePath.suffix(8)) + String(k_documentSubmitCharacteristicString.prefix(5)) + "imate"))
        //: imag.contentMode = .scaleAspectFill
        imag.contentMode = .scaleAspectFill
        //: imag.isUserInteractionEnabled = true
        imag.isUserInteractionEnabled = true
    ...
    private lazy var msgTableView: UITableView = {
        ...
        table.register(SeekVisitorShould.self, forCellReuseIdentifier: SeekVisitorShould.className())
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.setImage(UIImage.transferAndJoinSmall(name: (String(userReduceFormat))), for: .normal)
        //: btn.addTarget(self, action: #selector(closeBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(atPush), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension PlatformSendView {
    //: @objc private func closeBtnClick() {
    @objc private func atPush() {
        //: dismiss()
        it()
    }
...
extension PlatformSendView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: SeekVisitorShould.className(), for: indexPath) as! SeekVisitorShould
        //: if indexPath.section == 0 {
        if indexPath.section == 0 {
            //: if indexPath.row == 0 {
            if indexPath.row == 0 {
                //: cell.setCellData(msg: "Giving gifts 、making calls and sending paid messages can increase intimacy~".localized)
                cell.nearRevenue(msg: String(bytes: showHereData.reversed(), encoding: .utf8)!.localized)
                //: } else {
            } else {
                //: cell.setCellData(msg: "1 coin = 1 intimacy".localized)
                cell.nearRevenue(msg: (String(kBindTitle.suffix(6)) + " = 1 i" + appSecureStr.replacingOccurrences(of: "bot", with: "i") + const_scholarMessage.lowercased()).localized)
            }
            //: } else {
        } else {
            ...
            cell.nearRevenue(msg: String(bytes: noti_beyondPath.reversed(), encoding: .utf8)!.localized)
        }
        //: return cell
        return cell
    }
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let view = UIView(frame: CGRect(x: 0, y: 0, width: dataTabUrl, height: 32))
        //: view.backgroundColor = .clear
        view.backgroundColor = .clear
        //: let titleLab = UILabel()
        let titleLab = UILabel()
        //: titleLab.font = UIFont.pingfangMediumFont(fontSize: 16)
        titleLab.font = UIFont.wantStream(fontSize: 16)
