...
@objcMembers public class CleanShared: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func atArea(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class InsertSection: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: CleanShared?
    ...
    @objc dynamic public func panel(with data: CleanShared) {
        //: self.data = data
        self.data = data
    }
} 
