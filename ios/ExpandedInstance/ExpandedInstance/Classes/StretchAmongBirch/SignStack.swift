...
fileprivate let userEntityKey:[UInt8] = [0x1c,0x1b,0x1c,0x1,0x5d,0x16,0x1a,0x11,0x10,0x7,0x4f,0x5c,0x55,0x1d,0x14,0x6,0x55,0x1b,0x1a,0x1,0x55,0x17,0x10,0x10,0x1b,0x55,0x1c,0x18,0x5,0x19,0x10,0x18,0x10,0x1b,0x1,0x10,0x11]

private func answerWhole(mention num: UInt8) -> UInt8 {
    return num ^ 117
}

/*: "icon_gift_placeholder" :*/
fileprivate let dataHandleFormatTitle:[Character] = ["i","c","o","n","_","g","i","f","t","_","p","l","a","c","e","h","o","l","d","e","r"]

/*: "Gift" :*/
fileprivate let userImpactFormat:[Character] = ["G","i","f","t"]
...
class SignStack: UICollectionViewCell {
    //: override init(frame: CGRect) {
    override init(frame: CGRect) {
        //: super.init(frame: frame)
        super.init(frame: frame)
        //: self.setupSubviews()
        self.needCoordinator()
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: userEntityKey.map{answerWhole(mention: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .robotBy(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        imgV.image = UIImage.transferAndJoinSmall(name: (String(dataHandleFormatTitle)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var nameLab: UILabel = {
        ...
        lb.text = (String(userImpactFormat)).localized
...
extension SignStack {
    ...
    func highlightCalculate(giftModel: IncludeClip, _ isNewProfile: Bool) {
        //: giftImgView.setUrlImage(urlStr: giftModel.img)
        giftImgView.okUponLock(urlStr: giftModel.img)
