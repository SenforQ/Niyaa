...
fileprivate let kSpecMpPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Any" :*/
fileprivate let main_videoUrl:String = "three portraitAny"
...
class ProcessorView: HeadView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: kSpecMpPath.reversed(), encoding: .utf8)!)
    }
    ...
    override func activityEvaluation(button: UIButton) {
        ...
        if selectedValue.count <= 0 {
            ...
            selectedValue = dataArr.first ?? (String(main_videoUrl.suffix(3)))
        }
...
extension ProcessorView {
    /// 默认选中
    //: func normalSelectedComponent(value: String) {
    func insteadBlindRuling(value: String) {
...
extension ProcessorView: UIPickerViewDelegate, UIPickerViewDataSource {
