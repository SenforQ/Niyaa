...
Pod::Spec.new do |s|
  s.name         = "ExpandedInstance"
  s.version      = "1.0.0"
  s.summary      = "iOS ExpandedInstance Module."
  s.author       = { "ExpandedInstance" => "ExpandedInstance.me" }
  s.homepage     = "ExpandedInstance"
  s.source       = { :git => "http://ExpandedInstance.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'ExpandedInstance/Classes/**/*'
  s.resources = "ExpandedInstance/Resources/*.bundle"
