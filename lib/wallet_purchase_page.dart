...
class WalletPurchasePage extends StatefulWidget {
  const WalletPurchasePage({super.key});

  @override
  State<WalletPurchasePage> createState() => _WalletPurchasePageState();
}

class _WalletPurchasePageState extends State<WalletPurchasePage> {
        ...
        content: Column(
          ...
          children: const [
            _CoinRule(
                number: '1',
                text:
                    'Using the send message feature in NIYAA COOKING costs 30 Coins.'),
            SizedBox(height: 16),
            _CoinRule(
                number: '2',
                text: 'Using the add feature in NIYAA SHARE costs 5 Coins.'),
            SizedBox(height: 16),
            _CoinRule(
